...
__all__ = ['VinylWidget', 'SpectrumWidget', 'ProgressWidget', 'FingeringWidget', 'FingeringDisplay', 'LyricsWidget', 'AnimatedBackground', 'DynamicBackground', 'QingButton', 'ScrollProgressBar', 'PluckVolumeSlider']