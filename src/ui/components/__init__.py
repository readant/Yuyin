...
from .fingering_animation import FingeringAnimationWidget, FingeringSequenceWidget
...
__all__ = [
    ...
    'FingeringWidget', 'FingeringDisplay', 'FingeringAnimationWidget', 'FingeringSequenceWidget',
    'LyricsWidget', 'ScoreDisplayWidget', 'NoteUnit',
